...
int main(void)
{
  ...
  Lcd_cursor(&lcd, 0,0);
  Lcd_string(&lcd, "S SRI RAM\n");
  Lcd_cursor(&lcd, 1,2);
  Lcd_string(&lcd, "212222240105");
  HAL_Delay(500);
  while(1){}
}
void SystemClock_Config(void)
...
## Output screen shots of proteus  :
 ...
 ![WhatsApp Image 2024-04-02 at 10 56 40_11e95b7c](https://github.com/SriramS22/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/119094390/ac8c91c4-e308-4528-b5fd-55a2d6489062)




 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 ![image](https://github.com/SriramS22/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/119094390/30a0c386-81f4-4c8c-b9fb-65731bf74791)
